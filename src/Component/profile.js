    ...
    return (
        <div className='profile-container'>
          ...
          <button className='logout-btn'>LOGOUT</button>
            ...
            <img className='banner-img' src={img2}></img>
            <div className='user-part2'>
            <img className='user-img' src={img1}></img>
            <button className='edit-btn'>edit profile</button>
            </div>
          
            </div>
            <div className='user-info'>
                <h1 style={{fontWeight:500,fontSize:'4rem'}}>John novel</h1>
                <div className='connection'>12 <br/> Connections</div>
                <p> I am a front-end web developer skilled in HTML, CSS, and JavaScript, passionate about creating engaging user experiences. </p>
                <h3 style={{fontWeight:500,fontSize:'1.3rem',margin:'1rem'}}>Skill offered</h3>
                <ol style={{listStyle:'initial',margin:'1rem',color:'#34A853'}}>
                    <li>UI/UX Design</li>
                    <li>Responsive Web Design</li>
                    <li>Graphic Design</li>
                </ol>
                <h3 style={{fontWeight:500,fontSize:'1.3rem',margin:'1rem'}}>Skill requested</h3>
                <ol style={{listStyle:'initial',margin:'1rem',color:'#0085FE' }}>
                    <li>Version Control</li>
                    <li>Search Engine Optimization</li>
                   
                </ol>
                <p style={{margin:'1rem'}}>© 2025 Skill Sharing Platform. All rights reserved.</p>
            </div>
